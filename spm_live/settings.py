"""
Django settings for spm_live project.
...
CSRF_TRUSTED_ORIGINS= ["https://spm-analysis.up.railway.app"]

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-0y(do(vw8d$_$=v$%rlcn!_7rye*^hgv*!t-8)6*(p4^7yjg%f'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'spmApp/templates')],  # Make sure this path is correct
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # Your actual static directory
]
